...
public class BindTagsToIndexedFormParamsTest {
   ...
   public void test() {
      ...
      request = binder.bindToRequest(
            request,
            ImmutableMap.<String, Optional<String>> builder().put("one", Optional.of("alpha"))
                  .put("two", Optional.of("beta")).build());
   ...
   public void testEmpty() {
      ...
      request = binder.bindToRequest(request,
            ImmutableMap.<String, Optional<String>> builder().put("empty", Optional.<String> absent()).build());
