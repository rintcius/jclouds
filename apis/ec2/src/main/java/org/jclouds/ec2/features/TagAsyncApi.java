...
public interface TagAsyncApi {
   ...
   ListenableFuture<Void> apply(@BinderParam(BindTagsToIndexedFormParams.class) Map<String, Optional<String>> tags,
   ...
   /**
    * @see TagApi#deleteTagsFromResources
    * @see <a
   ...
   ListenableFuture<Void> deleteTagsFromResources(
         @BinderParam(BindTagKeysToIndexedFormParams.class) Iterable<String> tags,
         @BinderParam(BindResourceIdsToIndexedFormParams.class) Iterable<String> resourceIds);

   /**
    * @see TagApi#conditionalDeleteTagsFromResources
    * @see <a
    *      href="http://docs.amazonwebservices.com/AWSEC2/latest/APIReference/ApiReference-query-DeleteTags.html">docs</a>
    */
   @POST
   @Path("/")
   @FormParams(keys = ACTION, values = "DeleteTags")
   ListenableFuture<Void> conditionalDeleteTagsFromResources(
         @BinderParam(BindTagsToIndexedFormParams.class) Map<String, Optional<String>> conditionalTagValues,
         @BinderParam(BindResourceIdsToIndexedFormParams.class) Iterable<String> resourceIds);
